export default function navigation() {
    ...
    function play() {
        document.querySelector(".dashboard-play-button").addEventListener("click", () => {
                if (currentPageLocation != allPages[2]) {
                    const previousPage = currentPageLocation;
                    currentPageLocation = allPages[2];
                    navigateBetweenPages(previousPage, getGame);
    ...
    function logOut(){
        document.querySelector(".game-navigation-logout").addEventListener("click", () => {
            getOpeningPage.classList.remove("main-hide");
            getGameSection.classList.remove("section-game-show");
        });
